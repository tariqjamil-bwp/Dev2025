#https://nayakpplaban.medium.com/building-an-ai-powered-medical-document-analyzer-and-validator-4e22bbd91b4f
...
#load_dotenv()
api_key = 'CPwh8MBuXLO2R3W9waPb8MWku70jb6N3'
...
analyzer_llm = ChatGroq(
    model_name="llama3-70b-8192",#DeepSeek-R1-Distill-Llama-70B",
    temperature=0.6
)
